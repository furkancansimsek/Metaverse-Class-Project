...
namespace BNG {
    public class NetworkManager : MonoBehaviourPunCallbacks {
        ...
        public override void OnJoinedRoom() {
            ...
            object avatarLink;
            PhotonNetwork.LocalPlayer.CustomProperties.TryGetValue("Avatar_Link",out avatarLink );
            object[] myCustomInitData = new object[1];
            myCustomInitData[0] = avatarLink;
            // Network Instantiate the object used to represent our player. This will have a View on it and represent the player         
            GameObject player = PhotonNetwork.Instantiate(RemotePlayerObjectName, new Vector3(0f, 0f, 0f), Quaternion.identity, 0, myCustomInitData);
